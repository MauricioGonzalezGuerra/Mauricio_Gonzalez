...
mayor_precio = round(review['price'].max(),3)
vino_mayor_precio = review[review['price'] == mayor_precio]
...
california = pd.DataFrame(review[review['province'] == 'California'])
...
max_precio = review['price'].idxmax()
vino_caro = review.loc[max_precio]
